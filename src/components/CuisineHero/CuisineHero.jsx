  ...
  return (
    <div className="cuisine-hero">
      <div className="hero-body">
        <h1>{chef?.name}</h1>
        <p className="desc">hello my name is gordon ramsy. i am three time master chef winner and a lot of award winner along with notional award. I love to cook.</p>
